        ...
        .then(data => {
            ...
            if (matchedW.length === 0) {
                ...
                <div class="py-8 space-y-4 text-center col-span-full">
                    ...
                    <p class="bangla text-[#79716B]">এই Vocabulary এখনো যুক্ত করা হয়নি।।</p>
                    <h1 class="text-3xl text-[#292524] font-medium bangla"> অন্য Vocabulary Search করুন</h1>
                </div>
            
                `;
            }
            else if (inputch.length === 0) {
                ...
                <div class="py-8 space-y-4 text-center col-span-full">
                    <img src="assets/alert-error.png" alt="" class="mx-auto ">
                    <p class="bangla text-[#79716B]">কোন Vocabulary লেখেননি।।</p>
                    <h1 class="text-3xl text-[#292524] font-medium bangla">Vocabulary লেখে Search করুন</h1>
                </div>
...
const loadWordInfo = (id) => {
    ...
    fetch(`https://openapi.programming-hero.com/api/word/${id}`)
        ...
        .then(data => {
            ...
            modal.innerHTML = `
            <div>
                <h1 class="text-2xl font-bold">${(data.data.word)? data.data.word : 'শব্দ পাওয়া যায়নি'}  (<i class="fa-solid fa-microphone-lines"></i>: ${(data.data.pronunciation)? data.data.pronunciation : 'উচ্চারণ পাওয়া যায়নি'})</h1>
            </div>
            <div class="pt-4">
                <h3 class="py-1 font-bold">Meaning  </h3>
                <p class="py-1">${(data.data.meaning) ? data.data.meaning : 'অর্থ পাওয়া যায়নি'}</p>
            </div>
            <div>
            ...
            <div class="pt-4">
                ...
                <p class="py-1">${(data.data.sentence) ? data.data.sentence : 'উদাহরণ পাওয়া যায়নি'}</p>
            </div>
